...
public class AdminTest extends BaseClass {
	...
	public void admin_page_all_element_is_present() {
		...
		{
			if(para.getText().equals("For authorized users only. Unauthorized access prohibited and punishable by law."))
			{
		...
		else System.out.println("Admin username is FAIL");
		...
		else System.out.println("Admin Password is FAIL");
		...
		else System.out.println("Admin Login Btn is FAIL");
		...
		else System.out.println("Admin Forgot Pass is FAIL");
		...
		else System.out.println("Admin Main Menu is FAIL");
	...
	public void click_on_forgot_pass() {
		...
		else System.out.println("Page name is FAIL");
		...
		else System.out.println("Forgot page is FAIL");
		...
		else System.out.println("Recovery btn is FAIL");
		...
		else System.out.println("Admin_login_btn  is FAIL");
...
WebElement para = wd.findElement(By.xpath(prop.getProperty("para_text")));
	...
	public void click_on_Main_Menu_btn()
	{
		...
		else System.out.println("PhoneZone Logo is FAIL");
		...
		else System.out.println("Admin_button is FAIL");
		...
		else System.out.println("Staff_button is FAIL");
		...
		else System.out.println("wholeseller_button is FAIL");
